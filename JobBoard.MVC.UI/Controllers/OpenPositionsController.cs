...
namespace JobBoard.MVC.UI.Controllers
{
    public class OpenPositionsController : Controller
    {
        ...
        {
            ViewBag.LocationID = new SelectList(db.Locations, "LocationID", "Street");
        ...
        public ActionResult Create([Bind(Include = "OpenPositionID,LocationID,PositionID")] OpenPosition openPosition)
        {
            ...
            ViewBag.LocationID = new SelectList(db.Locations, "LocationID", "Street", openPosition.LocationID);
